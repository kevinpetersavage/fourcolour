...
degree_three_trivial_part_graph = nx.Graph()
degree_three_trivial_part_graph.add_edges_from(
    [(1, 2), (1, 3), (1, 4),  # spokes
     (2, 3), (3, 4), (4, 2),  # rim
...
degree_three_trivial_part = Part(
    K=degree_three_trivial_part_graph,
...
def test_generating_trivial_parts():
    ...
    expected = degree_three_trivial_part
